            ...
            <div class="mt-8 p-4 border border-gray-200 rounded-lg">
                ...
                <div class="mb-4">
                    ...
                    <select name="distribution_method" id="distribution_method" 
                        ...
                        <option value="last_payroll" {{ old('distribution_method', $deduction->distribution_method) === 'last_payroll' ? 'selected' : '' }}>
                            2nd Payroll (full amount on last payroll of month, ₱0.00 on others)
                        </option>
                        <option value="distribute_equally" {{ old('distribution_method', $deduction->distribution_method) === 'distribute_equally' ? 'selected' : '' }}>
