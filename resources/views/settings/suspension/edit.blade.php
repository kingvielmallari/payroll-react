...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Edit Suspension Day</h1>
        ...
        <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm">This suspension day is currently inactive.</p>
                </div>
            </div>
        </div>
        @endif
        ...
        <form method="POST" action="{{ route('settings.suspension.update', $suspension) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" 
                       ...
                       value="{{ old('name', $suspension->name) }}" 
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="type" id="type" 
                        ...
                        <option value="full_day_suspension" {{ old('type', $suspension->type) == 'full_day_suspension' ? 'selected' : '' }}>Full Day Suspension</option>
            ...
            <div id="date_fields" class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6" style="display: none;">
                ...
                <div>
                    ...
                    <input type="date" name="date_to" id="date_to" 
                           class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" 
                           value="{{ old('date_to', $suspension->date_to ? $suspension->date_to->format('Y-m-d') : '') }}">
