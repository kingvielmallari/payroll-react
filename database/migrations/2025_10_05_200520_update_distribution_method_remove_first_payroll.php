...
return new class extends Migration
{
    ...
    {
        // First, update any existing records with 'first_payroll' to 'last_payroll' as the closest alternative
        ...
        // Now update the enum to remove 'first_payroll' option
        ...
        // Update allowance_bonus_settings enum if the table exists
        if (Schema::hasTable('allowance_bonus_settings') && Schema::hasColumn('allowance_bonus_settings', 'distribution_method')) {
    ...
    {
        // Revert the enum changes to include 'first_payroll' option
        Schema::table('deduction_tax_settings', function (Blueprint $table) {
