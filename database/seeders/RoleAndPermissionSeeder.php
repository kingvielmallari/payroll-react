...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $hrHead->syncPermissions([
            ...
            'view cash advances', 'create cash advances', 'edit cash advances', 'approve cash advances',
            ...
            'view reports', 'export reports', 'generate reports', 'view payroll reports', 'view employee reports', 'view financial reports',
        ...
        $hrStaff->syncPermissions([
            'view dashboard',
            'view employees',
            'view payrolls', 'create payrolls', 'edit payrolls', 'process payrolls', 'generate payslips', 'send payslips',
            'view time logs', 'create time logs', 'edit time logs', 'import time logs',
            'view leave requests',
            'view deductions', 
            'view cash advances', 'create cash advances', 'edit cash advances',
            'view schedules', 'view holidays', 'view departments', 'view positions',
            'view reports', 'export reports', 'view payroll reports', 'view employee reports',
            'view own profile', 'edit own profile', 'view own payslips',
        ]);
        ...
        $employee->syncPermissions([
            'view dashboard',
            'view own time logs', 'edit own time logs',
            'view own leave requests', 'create own leave requests',
            'view own cash advances', 'create own cash advances',
            'view own profile', 'edit own profile', 'view own payslips',
        ]);
