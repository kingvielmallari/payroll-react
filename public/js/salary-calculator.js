...
function updateSalaryFields(sourceField) {
    ...
    // If field is empty or 0, clear all other fields
    if (!sourceValue || sourceValue === '0' || sourceValue === '') {
        ...
        if (previewElement) {
            previewElement.innerHTML = '<p class="text-gray-500 text-sm">Enter any salary rate to see calculations</p>';
        }
        return;
    }
